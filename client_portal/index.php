                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                        <div class="head-text-inner">
                            <h1> Trusted source for all types of electrical Control panels and solutions across all the
                                segments since 1986. </h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul id="main-menu" class="sm sm-blue">
                        ...
                        <li><a href="../preventive-maintenance.html">SERVICES</a>
                            <ul>
                                ...
                                <li><a class="dropdown-item" href="../preventive-maintenance.html">Preventive
                                        Maintenance</a></li>
                                <li><a class="dropdown-item" href="../comprehensive-maintenance.html">Comprehensive
                                        Maintenance</a></li>
                                ...
                                <li><a class="dropdown-item" href="../electrical-engg-services.html">Electrical Engg
                                        Services</a></li>
                            </ul>
                        </li>
                        <li><a href="../design-lab.html">INFRASTRUCTURE</a>
                            <ul>
                                ...
                                <li><a class="dropdown-item" href="../panel-manufacturing.html">Panel Manufacturing</a>
                                </li>
        ...
        <div id="carousel" class="carousel carousel-fade" data-ride="carousel" data-interval="4000">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="inner-banner-left mb-0 d-flex align-items-center"
                                style="min-height: 140px; padding-left: 50px !important;">
                                <h2 style="font-size:24px; margin: 0;"><b>SECURE PORTAL</b></h2>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="inner-bannerimg animated fadeInRight m-0" style="height: 140px;">
                                <img src="../content/public/images/Contact Us.webp" class="img-fluid w-100"
                                    style="height: 140px; object-fit: cover;" alt="Banner-1">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7 col-sm-10">
                    ...
                    <?php if ($error): ?>
                        <div class="alert alert-danger shadow-sm text-center"><i class="fas fa-exclamation-triangle"></i>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="foot-address">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="add-img"><img src="../content/public/images/BEC_Logo-1.webp"
                                        class="img-fluid" alt="BEC_Logo-1"></div>
                            </div>
                            <div class="col-lg-9">
                                <div class="location">
                                    <p><b>Balaji Electro Controls Pvt. Ltd.</b></p>
                                    <p>Corporate Office (Factory)</p>
                                    <p>36/2, Madanayakanahalli, Near Bhoruka School,Tumkur Road, Bengaluru - 562123,
                                        Karnataka, India</p>
                                    <p>Phone : <a href="tel:9341248803">+91 9341248803</a> / <a
                                            href="tel:9611102850">9611102850</a></p>
                ...
                <div class="col-lg-5">
                    <div class="foot-line"><img src="../content/public/images/Footer_Line.webp" class="img-fluid"
                            alt="Banner_Line.webp"></div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="foot-links">
                                <ul>
                                    <li><a href="../contact-us.html"><img
                                                class="../content/public/images/small-arrow.webp">Contact us</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3">
