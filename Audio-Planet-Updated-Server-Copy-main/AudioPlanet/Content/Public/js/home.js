$(document).ready(function () {
    ...
    $("img#img1").click(function () {
        var b = $(this).attr("src");
		if (b == "images/1.png") { b = "images/6.png"; } else if (b == "images/6.png") { b = "images/1.png"; }
        var a = $("img#img2").attr("src");
        var c = $("img#img3").attr("src");
        $("img#img1").attr("src", c);
        $("img#img2").fadeOut("slow", function () {
            $("img#img2").attr("src", b.replace("1", "1L").replace("5", "5L").replace("3", "3L").replace("4", "4L").replace("2", "2L").replace("6", "6L"));
            $("img#img2").effect("slide", 1000);
        });
        //$("img#img2").attr("src", b.replace("1", "1L").replace("5", "5L").replace("3", "3L").replace("4", "4L").replace("2", "2L").replace("6", "6L")).effect("slide", 1000);
        $("img#img3").attr("src", (a.indexOf("L") >= 0) ? a.replace("1L", "1").replace("5L", "5").replace("3L", "3").replace("4L", "4").replace("2L", "2").replace("6L", "6") : a);
    });
...
$('.feedback_hood').click(function(){
    ...
    $("img#img3").click(function () {
        ...
        $("img#img1").attr("src", (b.indexOf("L") >= 0) ? b.replace("1L", "1").replace("5L", "5").replace("3L", "3").replace("4L", "4").replace("2L", "2").replace("6L", "6") : b);
        $("img#img2").fadeOut("slow", function () {
            $("img#img2").attr("src", c.replace("1", "1L").replace("5", "5L").replace("3", "3L").replace("4", "4L").replace("2", "2L").replace("6", "6L"));
    ...
    $(function () {
        ...
        $(".contactUsPopUp").click(function () { $(".Enquery").toggle("slow"); });
