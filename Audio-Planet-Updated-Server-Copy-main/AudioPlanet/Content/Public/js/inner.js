$(document).ready(function () {
    ...
    //Sticky menu for Products Sub categories
    if ($("#Amplifier_menu").length > 0) {
        $("#Amplifier_menu").sticky({ topSpacing: 0 });
    }
    ...
    var $bindAllProducts = function () {
        ...
        if (!$.trim($("div#AmplifierDetails").html()).length) {
            if (cat == "Amplifier" || cat == "Source" || cat == "Speakers" || cat == "Turntables") {
                $.ajax({
